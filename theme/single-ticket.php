	...
	?>
		...
		<div class="entry-content">
			...
			<?php if ($wats_settings['ticket_status_key_enabled'] == 1)
					echo __("Current status : ",'WATS'). wats_ticket_get_status($post)."<br />"; ?>
			<?php if ($wats_settings['ticket_type_key_enabled'] == 1)
					echo __("Ticket type : ",'WATS'). wats_ticket_get_type($post)."<br />"; ?>
			<?php if ($wats_settings['ticket_product_key_enabled'] == 1)
					echo __("Ticket product : ",'WATS'). wats_ticket_get_product($post)."<br />"; ?>
			<?php echo __("Ticket originator : ",'WATS'); the_author(); echo "<br />"; ?>
			<div class="entry">
